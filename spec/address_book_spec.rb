...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    describe "import_from_csv_2" do
      it "imports the right amount of entries" do
      ...
      it "imports the 1st entry correctly" do
        book.import_from_csv_2("entries_2.csv")
        #Check the first entry
        entry_one = book.entries[0]
      ...
      it "imports the 2nd entry correctly" do
        book.import_from_csv_2("entries_2.csv")
        #Check the first entry
        entry_two = book.entries[1]
      ...
      it "imports the 3rd entry correctly" do
        book.import_from_csv_2("entries_2.csv")
        #Check the first entry
        entry_three = book.entries[2]
